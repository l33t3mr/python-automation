...
class SysForwTime(KPIsCallLevel):

    def initialize_attributes(self):
        # Class Attributes
        # CSV name
        self.csv_kpi_name = 'system_forwarding_times'
        # Default Table Headers in an ordered way
        self.all_table_headers = ['IMS Entity', 'IMS Entity Call Leg', 'Node Name', 'Forwarded Request Method',
                                  'Forwarding Time (s)']
    ...
    def open(self):
        ...
        sys_for = self.driver.find_element(By.CSS_SELECTOR,
                                           'ul > li[title="System Forwarding Time"] > a')
        sys_for.click()
