...
class SysForwTimePerEnt(KPIsReportLevel):
    ...
    def open(self):
        ...
        for_time_per_node = self.driver.find_element(By.CSS_SELECTOR,
                                                     'ul > li[title="System Forwarding Time per Entity"] > a')
